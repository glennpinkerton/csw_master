...
/*--------------------------------------------------------------------------*/
   ...
   * as addFill, addSymb, addText, addSymbol to draw primitives.
...
/*-----------------------------------------------------------------------------*/
    ...
    protected static native int getNativeSymbolParts (
        int        threadid,
        int        symb,
        double     size,
        double     angle,
...
/*
 * static methods used for returning the parts of a symbol in respnse
 * to a getSymbolParts call.  The parts are calculated on the native side
 * and returned as native_prims.
 */

    static ArrayList<NativePrim.Fill> symbNativeFillArray = null;
    static ArrayList<NativePrim.Line> symbNativeLineArray = null;
    static ArrayList<NativePrim.Text> symbNativeTextArray = null;
    static ArrayList<NativePrim.Arc> symbNativeArcArray = null;
    static ArrayList<NativePrim.FilledArc> symbNativeFilledArcArray = null;

    protected static void clearSymbolParts ()
    {
        symbNativeLineArray = null;
        symbNativeFillArray = null;
        symbNativeTextArray = null;
        symbNativeArcArray = null;
        symbNativeFilledArcArray = null;
    }

    protected static SymbolParts buildSymbolParts ()
    {
        SymbolParts sp = new SymbolParts ();
        sp.lineList = symbNativeLineArray;
        sp.fillList = symbNativeFillArray;
        sp.textList = symbNativeTextArray;
        sp.arcList =  symbNativeArcArray;
        sp.filledArcList = symbNativeFilledArcArray;

        return sp;
    }

    private static void addSymbNativeFill (
        float[]     xy,
        float       thickness,
        float       patScale,
        int         npts,
    ...
    {
        if (symbNativeFillArray == null) {
            symbNativeFillArray = new ArrayList<NativePrim.Fill> (10);
        }
        NativePrim.Fill native_fill = new NativePrim.Fill ();
        ...
        native_fill.pattern = pattern;
        native_fill.frame_num = frame_num;
        native_fill.image = image;
        native_fill.selectable = selectable;

        symbNativeFillArray.add (native_fill);

        return;
    }


    private static void addSymbNativeLine (
        float[]     xy,
        int         npts,
        int         red,
        int         green,
    ...
    )
    {
        ...
        if (symbNativeLineArray == null) {
            symbNativeLineArray = new ArrayList<NativePrim.Line> (10);
        }
        NativePrim.Line native_line = new NativePrim.Line ();
        ...
        symbNativeLineArray.add (native_line);

        return;
    }


    private static void addSymbNativeArc (
        float       x,
        float       y,
        float       r1,
        float       r2,
    ...
    {
        if (symbNativeArcArray == null) {
            symbNativeArcArray = new ArrayList<NativePrim.Arc> (BIG_CHUNK);
        }
        NativePrim.Arc native_arc = new NativePrim.Arc ();
     ...
     */
        ...
        native_arc.angle = angle;
        native_arc.frame_num = frame_num;
        native_arc.image = image;
        native_arc.selectable = selectable;

        symbNativeArcArray.add (native_arc);

        return;
    }


    private static void addSymbNativeFilledArc (
        float       x,
        float       y,
        float       r1,
        float       r2,
    ...
    {
        if (symbNativeFilledArcArray == null) {
            symbNativeFilledArcArray = new ArrayList<NativePrim.FilledArc> (BIG_CHUNK);
        }
        NativePrim.FilledArc native_filled_arc = new NativePrim.FilledArc ();
     ...
     */
        ...
        native_filled_arc.pattern = pattern;
        native_filled_arc.frame_num = frame_num;
        native_filled_arc.image = image;
        native_filled_arc.selectable = selectable;

        symbNativeFilledArcArray.add (native_filled_arc);
