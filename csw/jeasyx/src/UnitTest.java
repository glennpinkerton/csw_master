...
class UnitTest {
    ...
    static {
        System.loadLibrary ("jeasyx_test");
    }
...
//System.out.println ("at start of runMainMethod, thread = "+t);
        ...
        JDisplayList.openLogFile ("utest.ezx");
...

{
    ...
    public Frame1Frame ()
    {
        ...
        JEasyXGraphicsPanel gpanel = new JEasyXGraphicsPanel (BorderLayout.WEST);
...
class HugeFrame extends JFrame
{
    ...
    public HugeFrame ()
    {
        ...
        for (int ido=0; ido<ndo; ido++) {
            ...
            xr = random.nextDouble () * xymax;
            yr = random.nextDouble () * xymax;
            ...
            dl.setFillColor (255, 200, 0, 100);
            dl.setBorderColor (0, 0, 0, 100);
            dl.setFillPatternColor (0, 0, 0, 100);
            dl.addFill(xline, yline, icomp, 1, 1);
            ...
            dl.setFillColor (0, 0, 255);
            dl.setBorderColor (255, 0, 0);
            dl.addCircle (155.0 + xr, 155.0 + yr,
                          145.0 + xr, 145.0 + yr,
                          145.0 + xr, 155.0 + yr);
            ...
            dl.setFillColor (-1, -1, -1);
            dl.setBorderColor (0, 0, 0);
            dl.addCenteredRectangle (100.0 + xr, 55.0 + yr, 20.0, 14.0, 3.0, 45.0);
            ...
            dl.setFillColor (200, 250, 200);
            dl.setBorderColor (0, 0, 0);
            dl.addArc (80.0 + xr, 145.0 + yr, 10.0, 7.0, 45.0, 300.0, 0.0, 1);
            ...
            dl.setFillColor (-1, -1, -1);
            dl.setBorderColor (255, 0, 0);
            dl.addArc (80.0 + xr, 100.0 + yr, 10.0, 7.0, 45.0, 300.0, 90.0, 1);
            ...
            dl.setTextColor (0, 0, 0);
            dl.setFont (104);
            dl.addNumber (15.0 + xr, 150.0 + yr, .15, 0.0, 1.23, 2, 0);
            dl.addNumber (15.0 + xr, 170.0 + yr, .15, 0.0, 1.23456e15, 5, 0);
            dl.addNumber (15.0 + xr, 190.0 + yr, .15, 0.0, 123456789, 0, 1);
...
class LithFrame extends JFrame
{
    ...
    public LithFrame ()
    {
        ...
        JEasyXGraphicsPanel panel =
            new JEasyXGraphicsPanel (BorderLayout.WEST, mask);
        Container contentPane = getContentPane ();
        contentPane.add (panel);
