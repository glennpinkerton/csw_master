...
// their use.
    ...
    CSWPolyEdit (const CSWPolyEdit &old) = delete;
    const CSWPolyEdit &operator=(const CSWPolyEdit &old) = delete;
    CSWPolyEdit (CSWPolyEdit &&old) = delete;
    const CSWPolyEdit &operator=(CSWPolyEdit &&old) = delete;
