...
/*
        JButton jfrm_button = new JButton ("Empty JFrames");
        jfrm_button.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent ae){
              JFrame[] fa = new JFrame[10];
              for (int i=0; i<10; i++) {
                fa[i] = new JFrame();
                fa[i].setSize (500, 300);
                fa[i].setVisible(true);
              }
          }
        });

        JButton frm_button = new JButton ("Empty AWT Frames");
        frm_button.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent ae){
              Frame[] fa = new Frame[10];
              for (int i=0; i<10; i++) {
                fa[i] = new Frame();
                fa[i].setSize (500, 300);
                fa[i].setVisible(true);
...
//        contentPane.add (jfrm_button);
//        contentPane.add (frm_button);
