...
#define MULT(dest,v,factor) dest[0]=factor*v[0]; \
                            dest[1]=factor*v[1]; \
                            dest[2]=factor*v[2];

#define SET(dest,src) dest[0]=src[0]; \
                      dest[1]=src[1]; \
                      dest[2]=src[2];
...
{ \
        ...
        {                                         \
          /* triangles are coplanar */            \
          return coplanar_tri_tri(N1,V0,V1,V2,    \
                                     U0,U1,U2);   \
        }                                         \
}
...
inline int compute_intervals_isectline(
  ...
  if (D0D1>0.0f) {
    ...
    isecttwo(VERT2,VERT0,VERT1,
    VV2,VV0,VV1,
    D2,D0,D1,isect0,isect1,
    isectpoint0,isectpoint1);
...
#if 0
#define COMPUTE_INTERVALS_ISECTLINE(VERT0,VERT1,VERT2,       \
                                    VV0,VV1,VV2,             \
                                    D0,D1,D2,                \
                                    D0D1,D0D2,               \
                                    isect0,isect1,           \
