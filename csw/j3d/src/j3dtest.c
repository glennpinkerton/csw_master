...
int main(int argc, char *argv[]) {
  ...
  jar_file_list_append_jogl_files(jar_file_list);
  jvm_option_list = new_jvm_option_list(4);
  jvm_option_list_append_check_jni(jvm_option_list);
  jvm_option_list_append_max_heap_size(
    jvm_option_list,
    256 /* max_heap_size_in_mb */
  );
#if 0
  ...
  java_call_main_method(
    env,
    "csw/j3d/src/UnitTest" /* class_name */,
    "main" /* method_name */,
    argc,
    (char const **) argv
  );
